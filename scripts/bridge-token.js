...
const contractInfro = require('../artifacts/contracts/IBCToken.sol/IBCToken.json');
const configInfro = require('../config/config.json');

async function main(){
  try{
const mnemonic = 'innocent merit harbor rifle autumn cart corn wonder voice forward plastic embody';
    ...
    const method = contract.methods.crossChainTransfeer(configInfro.sendUniversalPacket[process.argv[2]].portAddr, channel, amount);
